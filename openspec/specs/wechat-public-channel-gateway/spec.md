# wechat-public-channel-gateway Specification

## Purpose
Provide the open-tag WeChat gateway contract for a token-gated ClawBot/OpenClaw endpoint that routes eligible WeChat traffic into `#all` and returns status/results back to the bot.
## Requirements
